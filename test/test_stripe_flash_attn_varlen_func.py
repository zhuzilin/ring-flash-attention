...
from ring_flash_attn import stripe_flash_attn_varlen_qkvpacked_func
...
def extract_local(value, cu_seqlens, rank, world_size):
    ...
    for i in range(len(cu_seqlens) - 1):
        ...
        seq_striped = value[start+rank:end:world_size].detach().clone()
        local_values.append(seq_striped)
...
if __name__ == "__main__":
    ...
    ring_out, ring_lse, _ = stripe_flash_attn_varlen_qkvpacked_func(
        local_qkv,
